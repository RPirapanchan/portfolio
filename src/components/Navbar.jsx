  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '18px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        {/* Logo */}
        <motion.a href="#home" whileHover={{ opacity: 0.8 }} style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.2rem', fontWeight: 700, letterSpacing: '0.22em', color: '#F5F1ED', textDecoration: 'none' }}>
